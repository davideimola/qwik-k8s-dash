...
export class LogsApi extends runtime.BaseAPI {
    ...
    /**
     */
    async logFileHandlerRaw(requestParameters: LogFileHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
    ...
    /**
     */
    async logFileHandler(requestParameters: LogFileHandlerRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
