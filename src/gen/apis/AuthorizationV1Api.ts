...
export class AuthorizationV1Api extends runtime.BaseAPI {
     ...
     */
    async createAuthorizationV1NamespacedLocalSubjectAccessReviewRaw(requestParameters: CreateAuthorizationV1NamespacedLocalSubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoK8sApiAuthorizationV1LocalSubjectAccessReview>> {
     ...
     * create a LocalSubjectAccessReview
     */
    async createAuthorizationV1NamespacedLocalSubjectAccessReview(requestParameters: CreateAuthorizationV1NamespacedLocalSubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IoK8sApiAuthorizationV1LocalSubjectAccessReview> {
     ...
     */
    async createAuthorizationV1SelfSubjectAccessReviewRaw(requestParameters: CreateAuthorizationV1SelfSubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoK8sApiAuthorizationV1SelfSubjectAccessReview>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * create a SelfSubjectAccessReview
     */
    async createAuthorizationV1SelfSubjectAccessReview(requestParameters: CreateAuthorizationV1SelfSubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IoK8sApiAuthorizationV1SelfSubjectAccessReview> {
     ...
     */
    async createAuthorizationV1SelfSubjectRulesReviewRaw(requestParameters: CreateAuthorizationV1SelfSubjectRulesReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoK8sApiAuthorizationV1SelfSubjectRulesReview>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * create a SelfSubjectRulesReview
     */
    async createAuthorizationV1SelfSubjectRulesReview(requestParameters: CreateAuthorizationV1SelfSubjectRulesReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IoK8sApiAuthorizationV1SelfSubjectRulesReview> {
     ...
     */
    async createAuthorizationV1SubjectAccessReviewRaw(requestParameters: CreateAuthorizationV1SubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoK8sApiAuthorizationV1SubjectAccessReview>> {
        if (requestParameters.body === null || requestParameters.body === undefined) {
     ...
     * create a SubjectAccessReview
     */
    async createAuthorizationV1SubjectAccessReview(requestParameters: CreateAuthorizationV1SubjectAccessReviewRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IoK8sApiAuthorizationV1SubjectAccessReview> {
     ...
     */
    async getAuthorizationV1APIResourcesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<IoK8sApimachineryPkgApisMetaV1APIResourceList>> {
        const queryParameters: any = {};
     ...
     * get available resources
     */
    async getAuthorizationV1APIResources(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<IoK8sApimachineryPkgApisMetaV1APIResourceList> {
