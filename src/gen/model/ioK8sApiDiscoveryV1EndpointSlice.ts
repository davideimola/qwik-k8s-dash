...
export class IoK8sApiDiscoveryV1EndpointSlice {
    ...
    */
    'addressType': IoK8sApiDiscoveryV1EndpointSlice.AddressTypeEnum;
    /**
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            ...
            "type": "IoK8sApiDiscoveryV1EndpointSlice.AddressTypeEnum"
        },
        {
            "name": "apiVersion",
            "baseName": "apiVersion",
...
export namespace IoK8sApiDiscoveryV1EndpointSlice {
