...
*/
export class IoK8sApiCoreV1TopologySpreadConstraint {
    ...
    */
    'nodeAffinityPolicy'?: IoK8sApiCoreV1TopologySpreadConstraint.NodeAffinityPolicyEnum;
    /**
    * NodeTaintsPolicy indicates how we will treat node taints when calculating pod topology spread skew. Options are: - Honor: nodes without taints, along with tainted nodes for which the incoming pod has a toleration, are included. - Ignore: node taints are ignored. All nodes are included.  If this value is nil, the behavior is equivalent to the Ignore policy. This is a beta-level feature default enabled by the NodeInclusionPolicyInPodTopologySpread feature flag.  Possible enum values:  - `\"Honor\"` means use this scheduling directive when calculating pod topology spread skew.  - `\"Ignore\"` means ignore this scheduling directive when calculating pod topology spread skew.
    */
    'nodeTaintsPolicy'?: IoK8sApiCoreV1TopologySpreadConstraint.NodeTaintsPolicyEnum;
    /**
    ...
    */
    'whenUnsatisfiable': IoK8sApiCoreV1TopologySpreadConstraint.WhenUnsatisfiableEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "IoK8sApiCoreV1TopologySpreadConstraint.NodeAffinityPolicyEnum"
        },
        {
            "name": "nodeTaintsPolicy",
            "baseName": "nodeTaintsPolicy",
            "type": "IoK8sApiCoreV1TopologySpreadConstraint.NodeTaintsPolicyEnum"
        },
        {
            "name": "topologyKey",
        ...
        },
        {
            ...
            "type": "IoK8sApiCoreV1TopologySpreadConstraint.WhenUnsatisfiableEnum"
        }    ];

    static getAttributeTypeMap() {
        return IoK8sApiCoreV1TopologySpreadConstraint.attributeTypeMap;
    }
}

export namespace IoK8sApiCoreV1TopologySpreadConstraint {
    export enum NodeAffinityPolicyEnum {
        Honor = <any> 'Honor',
        Ignore = <any> 'Ignore'
    }
    export enum NodeTaintsPolicyEnum {
        Honor = <any> 'Honor',
        Ignore = <any> 'Ignore'
    }
    export enum WhenUnsatisfiableEnum {
        DoNotSchedule = <any> 'DoNotSchedule',
        ScheduleAnyway = <any> 'ScheduleAnyway'
    }
}
