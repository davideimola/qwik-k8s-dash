...
export class IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRule {
    ...
    */
    'reason'?: IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRule.ReasonEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "reason",
            "baseName": "reason",
            "type": "IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRule.ReasonEnum"
        },
        {
            "name": "rule",
            "baseName": "rule",
    ...
    static getAttributeTypeMap() {
        return IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRule.attributeTypeMap;
    }
}

export namespace IoK8sApiextensionsApiserverPkgApisApiextensionsV1ValidationRule {
    export enum ReasonEnum {
        FieldValueDuplicate = <any> 'FieldValueDuplicate',
        FieldValueForbidden = <any> 'FieldValueForbidden',
        FieldValueInvalid = <any> 'FieldValueInvalid',
        FieldValueRequired = <any> 'FieldValueRequired'
    }
}
