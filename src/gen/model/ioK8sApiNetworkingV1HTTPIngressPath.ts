...
export class IoK8sApiNetworkingV1HTTPIngressPath {
    ...
    */
    'pathType': IoK8sApiNetworkingV1HTTPIngressPath.PathTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "pathType",
            "baseName": "pathType",
            "type": "IoK8sApiNetworkingV1HTTPIngressPath.PathTypeEnum"
        }    ];
...
export namespace IoK8sApiNetworkingV1HTTPIngressPath {
    export enum PathTypeEnum {
        Exact = <any> 'Exact',
        ImplementationSpecific = <any> 'ImplementationSpecific',
        Prefix = <any> 'Prefix'
    }
}
