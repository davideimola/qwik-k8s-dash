 ...
 * @export
 */
export const IoK8sApiCoreV1EphemeralContainerImagePullPolicyEnum = {
    Always: 'Always',
    IfNotPresent: 'IfNotPresent',
    Never: 'Never'
} as const;
export type IoK8sApiCoreV1EphemeralContainerImagePullPolicyEnum = typeof IoK8sApiCoreV1EphemeralContainerImagePullPolicyEnum[keyof typeof IoK8sApiCoreV1EphemeralContainerImagePullPolicyEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1EphemeralContainerTerminationMessagePolicyEnum = {
    FallbackToLogsOnError: 'FallbackToLogsOnError',
    File: 'File'
} as const;
export type IoK8sApiCoreV1EphemeralContainerTerminationMessagePolicyEnum = typeof IoK8sApiCoreV1EphemeralContainerTerminationMessagePolicyEnum[keyof typeof IoK8sApiCoreV1EphemeralContainerTerminationMessagePolicyEnum];
