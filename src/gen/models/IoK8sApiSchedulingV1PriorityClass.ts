...
export interface IoK8sApiSchedulingV1PriorityClass {
     ...
     * @memberof IoK8sApiSchedulingV1PriorityClass
     */
    preemptionPolicy?: IoK8sApiSchedulingV1PriorityClassPreemptionPolicyEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiSchedulingV1PriorityClassPreemptionPolicyEnum = {
    Never: 'Never',
    PreemptLowerPriority: 'PreemptLowerPriority'
} as const;
export type IoK8sApiSchedulingV1PriorityClassPreemptionPolicyEnum = typeof IoK8sApiSchedulingV1PriorityClassPreemptionPolicyEnum[keyof typeof IoK8sApiSchedulingV1PriorityClassPreemptionPolicyEnum];
