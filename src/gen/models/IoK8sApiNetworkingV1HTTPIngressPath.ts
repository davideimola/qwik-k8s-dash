...
export interface IoK8sApiNetworkingV1HTTPIngressPath {
     ...
     * @memberof IoK8sApiNetworkingV1HTTPIngressPath
     */
    pathType: IoK8sApiNetworkingV1HTTPIngressPathPathTypeEnum;
}
 ...
 * @export
 */
export const IoK8sApiNetworkingV1HTTPIngressPathPathTypeEnum = {
    Exact: 'Exact',
    ImplementationSpecific: 'ImplementationSpecific',
    Prefix: 'Prefix'
} as const;
export type IoK8sApiNetworkingV1HTTPIngressPathPathTypeEnum = typeof IoK8sApiNetworkingV1HTTPIngressPathPathTypeEnum[keyof typeof IoK8sApiNetworkingV1HTTPIngressPathPathTypeEnum];
