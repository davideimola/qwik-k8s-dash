 ...
 * @export
 */
export const IoK8sApiDiscoveryV1EndpointSliceAddressTypeEnum = {
    Fqdn: 'FQDN',
    Ipv4: 'IPv4',
    Ipv6: 'IPv6'
} as const;
export type IoK8sApiDiscoveryV1EndpointSliceAddressTypeEnum = typeof IoK8sApiDiscoveryV1EndpointSliceAddressTypeEnum[keyof typeof IoK8sApiDiscoveryV1EndpointSliceAddressTypeEnum];
