...
export interface IoK8sApiCoreV1TopologySpreadConstraint {
     ...
     * @memberof IoK8sApiCoreV1TopologySpreadConstraint
     */
    nodeAffinityPolicy?: IoK8sApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum;
    /**
     ...
     * @memberof IoK8sApiCoreV1TopologySpreadConstraint
     */
    nodeTaintsPolicy?: IoK8sApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum = {
    Honor: 'Honor',
    Ignore: 'Ignore'
} as const;
export type IoK8sApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum = typeof IoK8sApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum[keyof typeof IoK8sApiCoreV1TopologySpreadConstraintNodeAffinityPolicyEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum = {
    Honor: 'Honor',
    Ignore: 'Ignore'
} as const;
export type IoK8sApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum = typeof IoK8sApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum[keyof typeof IoK8sApiCoreV1TopologySpreadConstraintNodeTaintsPolicyEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum = {
    DoNotSchedule: 'DoNotSchedule',
    ScheduleAnyway: 'ScheduleAnyway'
} as const;
export type IoK8sApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum = typeof IoK8sApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum[keyof typeof IoK8sApiCoreV1TopologySpreadConstraintWhenUnsatisfiableEnum];
