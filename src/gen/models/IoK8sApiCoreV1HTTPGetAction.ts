 ...
 * @export
 */
export const IoK8sApiCoreV1HTTPGetActionSchemeEnum = {
    Http: 'HTTP',
    Https: 'HTTPS'
} as const;
export type IoK8sApiCoreV1HTTPGetActionSchemeEnum = typeof IoK8sApiCoreV1HTTPGetActionSchemeEnum[keyof typeof IoK8sApiCoreV1HTTPGetActionSchemeEnum];
