 ...
 * @export
 */
export const IoK8sApiCoreV1TolerationEffectEnum = {
    NoExecute: 'NoExecute',
    NoSchedule: 'NoSchedule',
    PreferNoSchedule: 'PreferNoSchedule'
} as const;
export type IoK8sApiCoreV1TolerationEffectEnum = typeof IoK8sApiCoreV1TolerationEffectEnum[keyof typeof IoK8sApiCoreV1TolerationEffectEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1TolerationOperatorEnum = {
    Equal: 'Equal',
    Exists: 'Exists'
} as const;
export type IoK8sApiCoreV1TolerationOperatorEnum = typeof IoK8sApiCoreV1TolerationOperatorEnum[keyof typeof IoK8sApiCoreV1TolerationOperatorEnum];
