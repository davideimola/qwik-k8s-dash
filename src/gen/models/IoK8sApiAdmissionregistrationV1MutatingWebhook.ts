...
export interface IoK8sApiAdmissionregistrationV1MutatingWebhook {
     ...
     * @memberof IoK8sApiAdmissionregistrationV1MutatingWebhook
     */
    failurePolicy?: IoK8sApiAdmissionregistrationV1MutatingWebhookFailurePolicyEnum;
    /**
     ...
     * @memberof IoK8sApiAdmissionregistrationV1MutatingWebhook
     */
    matchPolicy?: IoK8sApiAdmissionregistrationV1MutatingWebhookMatchPolicyEnum;
    /**
     ...
     * @memberof IoK8sApiAdmissionregistrationV1MutatingWebhook
     */
    reinvocationPolicy?: IoK8sApiAdmissionregistrationV1MutatingWebhookReinvocationPolicyEnum;
    /**
     ...
     * @memberof IoK8sApiAdmissionregistrationV1MutatingWebhook
     */
    sideEffects: IoK8sApiAdmissionregistrationV1MutatingWebhookSideEffectsEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiAdmissionregistrationV1MutatingWebhookFailurePolicyEnum = {
    Fail: 'Fail',
    Ignore: 'Ignore'
} as const;
export type IoK8sApiAdmissionregistrationV1MutatingWebhookFailurePolicyEnum = typeof IoK8sApiAdmissionregistrationV1MutatingWebhookFailurePolicyEnum[keyof typeof IoK8sApiAdmissionregistrationV1MutatingWebhookFailurePolicyEnum];

/**
 * @export
 */
export const IoK8sApiAdmissionregistrationV1MutatingWebhookMatchPolicyEnum = {
    Equivalent: 'Equivalent',
    Exact: 'Exact'
} as const;
export type IoK8sApiAdmissionregistrationV1MutatingWebhookMatchPolicyEnum = typeof IoK8sApiAdmissionregistrationV1MutatingWebhookMatchPolicyEnum[keyof typeof IoK8sApiAdmissionregistrationV1MutatingWebhookMatchPolicyEnum];

/**
 * @export
 */
export const IoK8sApiAdmissionregistrationV1MutatingWebhookReinvocationPolicyEnum = {
    IfNeeded: 'IfNeeded',
    Never: 'Never'
} as const;
export type IoK8sApiAdmissionregistrationV1MutatingWebhookReinvocationPolicyEnum = typeof IoK8sApiAdmissionregistrationV1MutatingWebhookReinvocationPolicyEnum[keyof typeof IoK8sApiAdmissionregistrationV1MutatingWebhookReinvocationPolicyEnum];

/**
 * @export
 */
export const IoK8sApiAdmissionregistrationV1MutatingWebhookSideEffectsEnum = {
    None: 'None',
    NoneOnDryRun: 'NoneOnDryRun',
    Some: 'Some',
    Unknown: 'Unknown'
} as const;
export type IoK8sApiAdmissionregistrationV1MutatingWebhookSideEffectsEnum = typeof IoK8sApiAdmissionregistrationV1MutatingWebhookSideEffectsEnum[keyof typeof IoK8sApiAdmissionregistrationV1MutatingWebhookSideEffectsEnum];
