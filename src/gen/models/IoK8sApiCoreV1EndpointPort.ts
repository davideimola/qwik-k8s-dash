 ...
 * @export
 */
export const IoK8sApiCoreV1EndpointPortProtocolEnum = {
    Sctp: 'SCTP',
    Tcp: 'TCP',
    Udp: 'UDP'
} as const;
export type IoK8sApiCoreV1EndpointPortProtocolEnum = typeof IoK8sApiCoreV1EndpointPortProtocolEnum[keyof typeof IoK8sApiCoreV1EndpointPortProtocolEnum];
