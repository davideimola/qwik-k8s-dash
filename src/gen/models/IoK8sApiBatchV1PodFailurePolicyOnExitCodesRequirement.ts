...
export interface IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirement {
     ...
     * @memberof IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirement
     */
    operator: IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirementOperatorEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirementOperatorEnum = {
    In: 'In',
    NotIn: 'NotIn'
} as const;
export type IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirementOperatorEnum = typeof IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirementOperatorEnum[keyof typeof IoK8sApiBatchV1PodFailurePolicyOnExitCodesRequirementOperatorEnum];
