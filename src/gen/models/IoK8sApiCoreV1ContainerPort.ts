 ...
 * @export
 */
export const IoK8sApiCoreV1ContainerPortProtocolEnum = {
    Sctp: 'SCTP',
    Tcp: 'TCP',
    Udp: 'UDP'
} as const;
export type IoK8sApiCoreV1ContainerPortProtocolEnum = typeof IoK8sApiCoreV1ContainerPortProtocolEnum[keyof typeof IoK8sApiCoreV1ContainerPortProtocolEnum];
