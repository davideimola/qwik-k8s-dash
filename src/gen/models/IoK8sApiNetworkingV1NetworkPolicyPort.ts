...
export interface IoK8sApiNetworkingV1NetworkPolicyPort {
     ...
     * @memberof IoK8sApiNetworkingV1NetworkPolicyPort
     */
    protocol?: IoK8sApiNetworkingV1NetworkPolicyPortProtocolEnum;
}
 ...
 * @export
 */
export const IoK8sApiNetworkingV1NetworkPolicyPortProtocolEnum = {
    Sctp: 'SCTP',
    Tcp: 'TCP',
    Udp: 'UDP'
} as const;
export type IoK8sApiNetworkingV1NetworkPolicyPortProtocolEnum = typeof IoK8sApiNetworkingV1NetworkPolicyPortProtocolEnum[keyof typeof IoK8sApiNetworkingV1NetworkPolicyPortProtocolEnum];
