 ...
 * @export
 */
export const IoK8sApiCoreV1ContainerImagePullPolicyEnum = {
    Always: 'Always',
    IfNotPresent: 'IfNotPresent',
    Never: 'Never'
} as const;
export type IoK8sApiCoreV1ContainerImagePullPolicyEnum = typeof IoK8sApiCoreV1ContainerImagePullPolicyEnum[keyof typeof IoK8sApiCoreV1ContainerImagePullPolicyEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1ContainerTerminationMessagePolicyEnum = {
    FallbackToLogsOnError: 'FallbackToLogsOnError',
    File: 'File'
} as const;
export type IoK8sApiCoreV1ContainerTerminationMessagePolicyEnum = typeof IoK8sApiCoreV1ContainerTerminationMessagePolicyEnum[keyof typeof IoK8sApiCoreV1ContainerTerminationMessagePolicyEnum];
