 ...
 * @export
 */
export const IoK8sApiAppsV1DeploymentStrategyTypeEnum = {
    Recreate: 'Recreate',
    RollingUpdate: 'RollingUpdate'
} as const;
export type IoK8sApiAppsV1DeploymentStrategyTypeEnum = typeof IoK8sApiAppsV1DeploymentStrategyTypeEnum[keyof typeof IoK8sApiAppsV1DeploymentStrategyTypeEnum];
