...
export interface IoK8sApiCoreV1PersistentVolumeSpec {
     ...
     * @memberof IoK8sApiCoreV1PersistentVolumeSpec
     */
    volumeMode?: IoK8sApiCoreV1PersistentVolumeSpecVolumeModeEnum;
    /**
     * 
 ...
 * @export
 */
export const IoK8sApiCoreV1PersistentVolumeSpecPersistentVolumeReclaimPolicyEnum = {
    Delete: 'Delete',
    Recycle: 'Recycle',
    Retain: 'Retain'
} as const;
export type IoK8sApiCoreV1PersistentVolumeSpecPersistentVolumeReclaimPolicyEnum = typeof IoK8sApiCoreV1PersistentVolumeSpecPersistentVolumeReclaimPolicyEnum[keyof typeof IoK8sApiCoreV1PersistentVolumeSpecPersistentVolumeReclaimPolicyEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1PersistentVolumeSpecVolumeModeEnum = {
    Block: 'Block',
    Filesystem: 'Filesystem'
} as const;
export type IoK8sApiCoreV1PersistentVolumeSpecVolumeModeEnum = typeof IoK8sApiCoreV1PersistentVolumeSpecVolumeModeEnum[keyof typeof IoK8sApiCoreV1PersistentVolumeSpecVolumeModeEnum];
