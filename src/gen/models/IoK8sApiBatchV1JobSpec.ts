...
export interface IoK8sApiBatchV1JobSpec {
     ...
     * @memberof IoK8sApiBatchV1JobSpec
     */
    completionMode?: IoK8sApiBatchV1JobSpecCompletionModeEnum;
    /**
     ...
     * @memberof IoK8sApiBatchV1JobSpec
     */
    podReplacementPolicy?: IoK8sApiBatchV1JobSpecPodReplacementPolicyEnum;
    /**
     * 
 ...
 * @export
 */
export const IoK8sApiBatchV1JobSpecCompletionModeEnum = {
    Indexed: 'Indexed',
    NonIndexed: 'NonIndexed'
} as const;
export type IoK8sApiBatchV1JobSpecCompletionModeEnum = typeof IoK8sApiBatchV1JobSpecCompletionModeEnum[keyof typeof IoK8sApiBatchV1JobSpecCompletionModeEnum];

/**
 * @export
 */
export const IoK8sApiBatchV1JobSpecPodReplacementPolicyEnum = {
    Failed: 'Failed',
    TerminatingOrFailed: 'TerminatingOrFailed'
} as const;
export type IoK8sApiBatchV1JobSpecPodReplacementPolicyEnum = typeof IoK8sApiBatchV1JobSpecPodReplacementPolicyEnum[keyof typeof IoK8sApiBatchV1JobSpecPodReplacementPolicyEnum];
