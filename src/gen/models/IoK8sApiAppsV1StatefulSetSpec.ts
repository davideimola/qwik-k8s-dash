 ...
 * @export
 */
export const IoK8sApiAppsV1StatefulSetSpecPodManagementPolicyEnum = {
    OrderedReady: 'OrderedReady',
    Parallel: 'Parallel'
} as const;
export type IoK8sApiAppsV1StatefulSetSpecPodManagementPolicyEnum = typeof IoK8sApiAppsV1StatefulSetSpecPodManagementPolicyEnum[keyof typeof IoK8sApiAppsV1StatefulSetSpecPodManagementPolicyEnum];
