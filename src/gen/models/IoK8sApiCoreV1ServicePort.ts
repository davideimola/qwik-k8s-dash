 ...
 * @export
 */
export const IoK8sApiCoreV1ServicePortProtocolEnum = {
    Sctp: 'SCTP',
    Tcp: 'TCP',
    Udp: 'UDP'
} as const;
export type IoK8sApiCoreV1ServicePortProtocolEnum = typeof IoK8sApiCoreV1ServicePortProtocolEnum[keyof typeof IoK8sApiCoreV1ServicePortProtocolEnum];
