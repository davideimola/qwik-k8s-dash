 ...
 * @export
 */
export const IoK8sApiBatchV1CronJobSpecConcurrencyPolicyEnum = {
    Allow: 'Allow',
    Forbid: 'Forbid',
    Replace: 'Replace'
} as const;
export type IoK8sApiBatchV1CronJobSpecConcurrencyPolicyEnum = typeof IoK8sApiBatchV1CronJobSpecConcurrencyPolicyEnum[keyof typeof IoK8sApiBatchV1CronJobSpecConcurrencyPolicyEnum];
