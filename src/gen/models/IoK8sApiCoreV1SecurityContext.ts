...
export interface IoK8sApiCoreV1SecurityContext {
     ...
     * @memberof IoK8sApiCoreV1SecurityContext
     */
    procMount?: IoK8sApiCoreV1SecurityContextProcMountEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiCoreV1SecurityContextProcMountEnum = {
    Default: 'Default',
    Unmasked: 'Unmasked'
} as const;
export type IoK8sApiCoreV1SecurityContextProcMountEnum = typeof IoK8sApiCoreV1SecurityContextProcMountEnum[keyof typeof IoK8sApiCoreV1SecurityContextProcMountEnum];
