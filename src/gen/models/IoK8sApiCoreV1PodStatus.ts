 ...
 * @export
 */
export const IoK8sApiCoreV1PodStatusPhaseEnum = {
    Failed: 'Failed',
    Pending: 'Pending',
    Running: 'Running',
    Succeeded: 'Succeeded',
...
export type IoK8sApiCoreV1PodStatusPhaseEnum = typeof IoK8sApiCoreV1PodStatusPhaseEnum[keyof typeof IoK8sApiCoreV1PodStatusPhaseEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1PodStatusQosClassEnum = {
    BestEffort: 'BestEffort',
    Burstable: 'Burstable',
    Guaranteed: 'Guaranteed'
} as const;
export type IoK8sApiCoreV1PodStatusQosClassEnum = typeof IoK8sApiCoreV1PodStatusQosClassEnum[keyof typeof IoK8sApiCoreV1PodStatusQosClassEnum];
