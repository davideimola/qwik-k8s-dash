...
export interface IoK8sApiCoreV1AzureDiskVolumeSource {
     ...
     */
    cachingMode?: IoK8sApiCoreV1AzureDiskVolumeSourceCachingModeEnum;
    /**
     ...
     * @memberof IoK8sApiCoreV1AzureDiskVolumeSource
     */
    kind?: IoK8sApiCoreV1AzureDiskVolumeSourceKindEnum;
    /**
 ...
 * @export
 */
export const IoK8sApiCoreV1AzureDiskVolumeSourceCachingModeEnum = {
    None: 'None',
    ReadOnly: 'ReadOnly',
    ReadWrite: 'ReadWrite'
} as const;
export type IoK8sApiCoreV1AzureDiskVolumeSourceCachingModeEnum = typeof IoK8sApiCoreV1AzureDiskVolumeSourceCachingModeEnum[keyof typeof IoK8sApiCoreV1AzureDiskVolumeSourceCachingModeEnum];

/**
 * @export
 */
export const IoK8sApiCoreV1AzureDiskVolumeSourceKindEnum = {
    Dedicated: 'Dedicated',
    Managed: 'Managed',
    Shared: 'Shared'
} as const;
export type IoK8sApiCoreV1AzureDiskVolumeSourceKindEnum = typeof IoK8sApiCoreV1AzureDiskVolumeSourceKindEnum[keyof typeof IoK8sApiCoreV1AzureDiskVolumeSourceKindEnum];
