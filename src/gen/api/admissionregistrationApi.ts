...
export class AdmissionregistrationApi {
     ...
     */
    public async getAdmissionregistrationAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgApisMetaV1APIGroup;  }> {
