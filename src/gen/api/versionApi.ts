...
export class VersionApi {
     ...
     */
    public async getCodeVersion (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgVersionInfo;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgVersionInfo;  }>((resolve, reject) => {
