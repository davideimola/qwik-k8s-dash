...
export class RbacAuthorizationApi {
     ...
     */
    public async getRbacAuthorizationAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgApisMetaV1APIGroup;  }> {
