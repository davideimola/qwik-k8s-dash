...
export class FlowcontrolApiserverApi {
     ...
     */
    public async getFlowcontrolApiserverAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgApisMetaV1APIGroup;  }> {
