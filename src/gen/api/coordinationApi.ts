...
export class CoordinationApi {
     ...
     */
    public async getCoordinationAPIGroup (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IoK8sApimachineryPkgApisMetaV1APIGroup;  }> {
