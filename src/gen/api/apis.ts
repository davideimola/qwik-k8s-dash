...
export * from './metricsV1beta1Api';
import { MetricsV1beta1Api } from './metricsV1beta1Api';
...
export const APIS = [AdmissionregistrationApi, AdmissionregistrationV1Api, ApiextensionsApi, ApiextensionsV1Api, ApiregistrationApi, ApiregistrationV1Api, ApisApi, AppsApi, AppsV1Api, AuthenticationApi, AuthenticationV1Api, AuthorizationApi, AuthorizationV1Api, AutoscalingApi, AutoscalingV1Api, AutoscalingV2Api, BatchApi, BatchV1Api, CertificatesApi, CertificatesV1Api, CoordinationApi, CoordinationV1Api, CoreApi, CoreV1Api, DiscoveryApi, DiscoveryV1Api, EventsApi, EventsV1Api, FlowcontrolApiserverApi, FlowcontrolApiserverV1beta2Api, FlowcontrolApiserverV1beta3Api, LogsApi, MetricsApi, MetricsV1beta1Api, NetworkingApi, NetworkingV1Api, NodeApi, NodeV1Api, OpenidApi, PolicyApi, PolicyV1Api, RbacAuthorizationApi, RbacAuthorizationV1Api, SchedulingApi, SchedulingV1Api, StorageApi, StorageV1Api, VersionApi, WellKnownApi];
